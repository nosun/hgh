...
$allowreferer = array(
   ...
   strtolower( '/e/memberconnect/sina/install')
);
...
<title>帝国CMS－新浪微博交互插件安装/卸载程序</title>
...
<form method="GET" action="index.php" name="formupdate" onsubmit="return CheckUpdate(document.formupdate);">
  ...
  <table width="500" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#4FB4DE">
    <tr> 
      <td height="30" colspan="2"> <div align="center"><strong><font color="#FFFFFF">帝国CMS－新浪微博交互插件安装/卸载程序</font></strong></div></td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
