...
if($enews=="MAddInfo")
{
	...
	if($cr['qaddshowkey'])
	{
      ...
      <td height=\"25\"><input name=\"key\" type=\"text\" size=\"6\">
        <img src=\"../ShowKey/?v=info\" onclick=\"javascript:this.src = '../ShowKey/?v=' + '?v=info&n=' + Math.random();\"></td></tr>";
	}
	//图片
	$imgwidth=0;
	$imgheight=0;
...
$postclass="<a>".$class_r[$classid]['classname']."</a>".$rechangeclass;
if($cr['bclassid'])
{
	$bcr['classid']=$cr['bclassid'];
	$bclassurl=sys_ReturnBqClassname($bcr,9);
	$postclass="<a>".$class_r[$cr['bclassid']]['classname']."</a>&nbsp;>&nbsp;".$postclass;
}
//html编辑器
