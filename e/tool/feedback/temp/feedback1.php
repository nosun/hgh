	...
	<body>
            ...
            <div class="wrap wrap-1">
                <div class="header width clearfix">
                    <img src="http://www.szhgh.com/skin/default/images/navlogo.jpg" />
                    <div class="box right">
            ...
            <div id="main">
                <div class="position_cur">
                    <div class="subnav">现在的位置：<a href="http://www.szhgh.com/">红歌会网</a>&nbsp;&gt;&nbsp;网址导航留言板</div>
                </div>
                ...
                <div class="form_module">
                    <form name='feedback' method='post' enctype='multipart/form-data' action='../../enews/index.php'>
                        ...
                        <div class="form_item">
                            <label>推荐网站站名 :</label>
                            <div class="form_input"><input name='recommend_sitename' type='text' value='' /></div>
                        </div>
                        <div class="form_item">
                            <label>网址 :</label>
                            <div class="form_input"><input name='recommend_siteurl' type='text' value='' /></div>
                        </div>
                        <div class="form_item">
                            <label>留言标题 :</label>
                            <div class="form_input"><input name='title' type='text' value='' />&nbsp; * （必填）</div>
                        </div>                        
                        <div class="form_item">
                            <label>留言内容 :</label>
                            <div class="form_input"><textarea name='saytext' cols='60' rows='12'></textarea>&nbsp; * （必填）</div>
                        </div>
                        ...
                        <div class="form_item">
                            <label>邮箱 :</label>
                            <div class="form_input"><input name='email' type='text' value='' /></div>
                        </div>                                                                                            
                        <div class="form_item">
                            <label>电话 :</label>
                            <div class="form_input"><input name='mycall' type='text' value='' /></div>
                        </div>
                        <div class="form_item">
                            <label>QQ :</label>
                            <div class="form_input"><input name='qq' type='text' value='' /></div>
                        </div>
                ...
                <div id="message" class="message">
                    <ul class="list">
                    <?
                        $sql    =   $empire->query("select title,saytext,saytime from {$dbtbpre}enewsfeedback order by saytime DESC");
                        while($r=$empire->fetch($sql))        //循环获取查询记录
                        {
                    ?>
                        <li>
                            <div class="message_header">
                                <span class="name">标题: <strong><?=$r['title']?></strong> </span>
                                <span class="lytime">留言时间: <?=$r['saytime']?> </span>
                                <div class="clear_float"></div>
                            </div>
                            <div class="content">
                                <div class="lytext"> <?=$r['saytext']?></div>
                            </div>
                        </li>
                    <?
                        }
...
document.write(unescape("%3Cscript src='" + _bdhmProtocol + "hm.baidu.com/h.js%3F2e62d7088e3926a4639571ba4c25de10' type='text/javascript'%3E%3C/script%3E"));
            ...
            <li class="focusmsg">
                <div>网站QQ：<a href="http://wpa.qq.com/msgrd?Uin=1962727933" title="欢迎通过QQ联系我们" target="_blank">1962727933</a>&nbsp;&nbsp;红歌会网粉丝QQ群：166238344</div>
