...
//存储后台的路径
$adminp = dirname(__FILE__);
$adminpn = substr($adminp, strrpos($adminp,DIRECTORY_SEPARATOR)+1);
esetcookie('pathn', $adminpn, 0, 1, TRUE);//LGM 添加,存储后台路径[2014年3月12日17:44]
//变量处理
$empirecmskey1='';
$empirecmskey2='';
$empirecmskey3='';
    ...
    <tr> 
      <td height="80"> <table width="230" height="100%" border="0" align="right" cellpadding="0" cellspacing="0">
          ...
          <tr> 
            ...
            <td width="97"><img src="ShowKey.php" name="KeyImg" id="KeyImg" align="bottom" onclick="javascript:this.src='ShowKey.php?n='+Math.random();" title="看不清楚,点击刷新" alt="验证码"></td>
          </tr>
          <?php
		  }
		  ?>
