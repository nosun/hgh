...
$r=$empire->fetch1("select * from {$dbtbpre}ecms_".$tbname." where id='$id' limit 1",MYSQL_ASSOC);
...
//副表
$finfor=$empire->fetch1("select ".ReturnSqlFtextF($mid)." from {$dbtbpre}ecms_".$tbname."_data_".$r['stb']." where id='$r[id]' limit 1",MYSQL_ASSOC);
...
$diy_cmd="select tempid,temptext,showdate from ".GetTemptb("enewsnewstemp")." where tempid='$r[newstempid]'";
$newstemp_r=$empire->fetch1($diy_cmd,MYSQL_ASSOC);
//替换模板变量
