<?php 
require_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'class'.DIRECTORY_SEPARATOR.'connect.php');
...
if($tobind&&($enews=='login'||$enews=='register'))
{
	...
	include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'memberconnect'.DIRECTORY_SEPARATOR.'memberconnectfun.php');
}

//----------------------- Ucenter -----------------------
if(defined('UC_ENABLE') && UC_ENABLE && $enews=='login'||$enews=='register'||$enews=='EditSafeInfo'||$enews=='exit'||$enews=='DoGetPassword')
{
	include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'config.inc.php');
	include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'client'.DIRECTORY_SEPARATOR.'client.php');
}


if($enews=='login'||$enews=='exit')
{
	include_once('class/member_loginfun.php');
}
elseif($enews=='register')
{
	include_once('class/member_registerfun.php');
	include_once('class/member_modfun.php');
}
elseif($enews=='EditSafeInfo'||$enews=='EditInfo')
{
	include_once('class/member_editinfofun.php');
	include_once('class/member_modfun.php');
}
...
{
	include_once(dirname(__FILE__).DIRECTORY_SEPARATOR.'..'.DIRECTORY_SEPARATOR.'data'.DIRECTORY_SEPARATOR.'dbcache'.DIRECTORY_SEPARATOR.'class.php');
	include_once('class/favfun.php');
}
elseif($enews=='AddMsg'||$enews=='DelMsg'||$enews=='DelMsg_all')
{
	include_once('class/msgfun.php');
}
elseif($enews=='AddFriend'||$enews=='EditFriend'||$enews=='DelFriend'||$enews=='AddFriendClass'||$enews=='EditFriendClass'||$enews=='DelFriendClass')
{
	include_once('class/friendfun.php');
}
elseif($enews=='CardGetFen')
{
	include_once('class/membercomfun.php');
}
