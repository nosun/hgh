...
if($mhavelogin==1) {
?>
document.write("<div id=\"plpost\" class=\"section_content\" havelogin=\"<?=$mhavelogin?>\">    <div class=\"inputpl\">        <div class=\"avatar f-fl\">            <img src=\"<?=$userpic?>\" />        </div>        <div class=\"inputarea f-fr\">                                                  <div class=\"retext\">                    <textarea name=\"lytext\" cols=\"58\" rows=\"4\" id=\"lytext\"></textarea>                   <div class=\"state\" id=\"statebox\" style=\"display: none;\">                     </div>                </div>                <div class=\"subtool\">                    <div class=\"f-fl\"></div>                    <div class=\"f-fr\"><input class=\"submitbutton\" type=\"submit\" name=\"Submit3\" value=\"提交留言\" /></div>                    <div class=\"f-cb\"></div>      <input name=\"name\" type=\"hidden\" id=\"name\" value=\"<?= $myusername ?>\" />          </div>    </div>        <div class=\"f-cb\"></div>    </div></div>");
<?
} else {
?>
document.write("<div id=\"plpost\" class=\"section_content\" havelogin=\"<?=$mhavelogin?>\">    <div class=\"inputpl\">        <div class=\"avatar f-fl\">            <img src=\"http://www.szhgh.com/e/data/images/nouserpic.jpg\" />        </div>        <div class=\"inputarea f-fr\">            <form action=\"http://www.szhgh.com/e/pl/doaction.php\" method=\"post\" name=\"saypl\" id=\"saypl\" onsubmit=\"return CheckPl(document.saypl)\">                                       <div class=\"retext\">                    <div class=\"state\" id=\"statebox\" style=\"\">                        <span class=\"msg\">请先&nbsp;<a href=\"#loginmodal\" title=\"点此登录\" class=\"flatbtn loginbutton\" id=\"modaltrigger_plinput\">登录</a>&nbsp;<a class=\"registerbutton\" href=\"http://www.szhgh.com/e/member/register/\" title=\"点此注册本站账号\" target=\"_blank\">还没有注册？</a><span><script type=\"text/javascript\">document.write(\'<script type=\"text/javascript\" src=\"http://www.szhgh.com/e/memberconnect/panjs.php?type=login&dclass=login<?php  $op_pt='&pagetitle='.urlencode($_REQUEST['pagetitle']);if(!empty($_REQUEST['titlepic'])) $op_pt .='&titlepic='.urlencode($_REQUEST['titlepic']);if(!empty($_REQUEST['playurl'])){ $cur_id = 0;if(isset($id))$cur_id = $id;else $cur_id = $_REQUEST['id'];if($cur_id)    {     if(isset($GLOBALS['__playurl']))$GLOBALS['__playurl'] = array();     $GLOBALS['__playurl'][$cur_id]=$_REQUEST['playurl'];     $op_pt.='&id'.$cur_id;    }} $op_url =$op_pt.'&titleurl='.urlencode($_REQUEST['titleurl']);echo $op_url; ?>&t=\'+Math.random()+\'\"></\'+\'script>\');</script></span></span>                    </div>                </div>                <div class=\"subtool\">                    <div class=\"f-fl\">                        <div class=\"sync\">                        </div>                    </div>                    <div class=\"f-fr\"><input class=\"submitbutton\" name=\"imageField\" type=\"submit\" id=\"imageField\" disabled=\"true\" value=\"发表评论\" /></div>                    <div class=\"f-cb\"></div>                </div>                <input name=\"id\" type=\"hidden\" id=\"id\" value=\"<?=$id?>\" />                <input name=\"classid\" type=\"hidden\" id=\"classid\" value=\"<?=$classid?>\" />                <input name=\"enews\" type=\"hidden\" id=\"enews\" value=\"AddPl\" />                <input name=\"repid\" type=\"hidden\" id=\"repid\" value=\"0\" />            </form>        </div>        <div class=\"f-cb\"></div>    </div></div>");
<?
}
?>