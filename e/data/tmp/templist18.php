...
<html xmlns:wb="http://open.weibo.com/wb" xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="article_sonlist customlist">
...
<script type="text/javascript">
    $(document).ready(function ($) {
        ...
        <div class="container">
            ...
            <div class="main">
                <div class="position_cur clearfix">
                    <strong class="left">当前位置：[!--newsnav--]</strong>
                    <span class="notice">(最新评论的将排在最前面)</span>
                    <em class="right">
                        <a target="_blank" title="点此查看最新文章" href="[!--news.url--]html/news/">最新</a>
                        | <a target="_blank" title="点此查看头条文章" href="[!--news.url--]html/firsttitle/">头条</a>
                        | <a target="_blank" title="点此查看推荐文章" href="[!--news.url--]html/isgood/">推荐</a>
                        | <a target="_blank" title="点此查看视频文章" href="[!--news.url--]html/video/">视频</a> 
                        <span class="notice_firsttitle">头条文章</span>
                        <span class="notice_isgood">推荐文章</span>
                    </em>
                </div>
