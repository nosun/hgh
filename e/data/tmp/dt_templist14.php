            ...
            <div class="container">
                <div class="sidebar">
                    ...
                    <div class="section isgood">
                        ...
                        <ul class="section_content ">
                           ...
                           <? @sys_GetClassNewsPic(0,2,4,128,90,1,20,3);?>
                        </ul>                        
                    </div>
                    ...
                    <div class="section">
                        ...
                        <ul class="section_content">
                            <? @sys_GetEcmsInfo(0,10,40,0,4,2,0);?> 
                        </ul> 
                        ...
                        <ol class="section_content rank">
                             <? @sys_GetEcmsInfo(0,10,40,0,4,10,0,'newstime > UNIX_TIMESTAMP()-86400*30','onclick DESC');?>
                        </ol>                          
                ...
                <div class="main">
                    <div class="position_cur">
                        <img src="[!--news.url--]skin/default/images/arrow_icon.gif" />您当前的位置：[!--newsnav--]
                    </div>
