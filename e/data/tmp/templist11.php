...
<html xmlns:wb="http://open.weibo.com/wb" xmlns="http://www.w3.org/1999/xhtml">
	...
	<div class="navwrap">
		<div class="navigation" id="js_controlclassid">
			...
			<div class="right rightwrap">
				<ul class="sonclasslist left" id="js_currentclass">
					<li><a title="学者专栏" href="/xuezhe/">学者专栏</a></li>
					<li class="current"><a title="网友文集" href="/netizens/">网友文集</a></li>
				</ul>
			...
			<div class="section">
				<div class="section_header">
					<strong>热门文章</strong>
						...
						<ul class="commonlist">
					<?	
						$sql=$empire->query("select a.title,a.titleurl from hgh_ecms_article a inner join hgh_ecms_author b on a.author=b.title and b.classid=2 where a.newstime > UNIX_TIMESTAMP()-86400*30 order by a.onclick desc limit 0,10");
		...
		<div class="main">
			...
			<div class="clearfix" id="author_article">
				 <div class="left" id="list_new">
					...
					<ul class="commonlist">
					<?
						$sql=$empire->query("select a.title,a.titleurl from hgh_ecms_article a inner join hgh_ecms_author b on a.author=b.title and b.classid=2 order by a.newstime desc limit 0,10");
						while($r=$empire->fetch($sql)){
					?>
				...
				<div class="right" id="list_elite">
					<ul class="toutiaolist">
						<?
							$sql=$empire->query("select a.title,a.smalltext,a.titleurl from hgh_ecms_article a inner join hgh_ecms_author b on a.author=b.title and b.classid=2 where a.firsttitle>0 order by a.newstime desc limit 0,3");
							$i=1;
							while($r=$empire->fetch($sql)){
						?>
