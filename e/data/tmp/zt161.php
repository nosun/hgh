...
<head>
    ...
    <title>不忘初心的马老，您走好 - <?=$public_r['sitename']?></title>
    <meta name="keywords" content="" />
    <meta name="description" content="2017年3月27日，曾被毛主席誉为“马宾宪法”的“鞍钢宪法”首创者、革命老人马宾逝世。马老一身正气，两袖清风，不忘初心，继续革命，是真正的共产主义战士。" />
...
<?
        $ztid=161;  //取得当前专题id并赋给变量$ztid，以供SQL查询使用；
    ...
    <div class="hea_2" style='background: url("<?=$zt_r[ztbg]?>") no-repeat scroll center center transparent;'>
        <div class="g-wrap f-cb">
            <div class="m-guide f-fl">
                ...
                <div  style="color:<?=$parameter_r[0]?>;" class="u-intro">2017年3月27日，曾被毛主席誉为“马宾宪法”的“鞍钢宪法”首创者、革命老人马宾逝世。马老一身正气，两袖清风，不忘初心，继续革命，是真正的共产主义战士。</div>
            </div>
...
<!--PC版-->
<div id="SOHUCS" sid="不忘初心的马老，您走好" ></div>
...
conf: 'prod_eb841ff6ba533cd3f322c05e9252c602'
    ...
    <!--底部结束-->
    <script src=http://www.szhgh.com/e/public/onclick/?enews=dozt&ztid=161></script>
</body>
</html>