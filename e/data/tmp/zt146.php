...
<head>
    ...
    <title>纪念毛主席诞辰123周年 - <?=$public_r['sitename']?></title>
    <meta name="keywords" content="" />
    <meta name="description" content="今年12月26日是人民领袖毛泽东主席诞辰123周年的日子，全国各地人民群众都在深情纪念，就像过节一样，约定俗成。这是中国人民自己的节日。" />
...
<?
        $ztid=146;  //取得当前专题id并赋给变量$ztid，以供SQL查询使用；
    ...
    <div class="hea_2" style='background: url("<?=$zt_r[ztbg]?>") no-repeat scroll center center transparent;'>
        <div class="g-wrap f-cb">
            <div class="m-guide f-fl">
                ...
                <div  style="color:<?=$parameter_r[0]?>;" class="u-intro">今年12月26日是人民领袖毛泽东主席诞辰123周年的日子，全国各地人民群众都在深情纪念，就像过节一样，约定俗成。这是中国人民自己的节日。</div>
            </div>
...
<!--PC版-->
<div id="SOHUCS" sid="纪念毛主席诞辰123周年" ></div>
...
conf: 'prod_eb841ff6ba533cd3f322c05e9252c602'
    ...
    <!--底部结束-->
    <script src=http://www.szhgh.com/e/public/onclick/?enews=dozt&ztid=146></script>
</body>
</html>