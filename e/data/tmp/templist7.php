                ...
                <div class="sidebar">
                    ...
                    <div class="section isgood">
                        ...
                        <div class="section_content ">
                            <? @sys_GetClassNewsPic('selfinfo',2,4,140,106,1,20,2);?>
                        </div>
                    </div>
...
?>
                                ...
                                <div class='summary'>
                                    ...
                                    <div class="right">
                                        <p><a href="<?=$bqsr['titleurl']?>" title="点击阅读全文" target="_blank"><?=htmlspecialchars_decode(esub(strip_tags($bqr['smalltext']),100))?></a></p>
                                    </div>
                                    <div class="clear"></div>
                                </div>                        
                            <?php
