...
<html xmlns:wb="http://open.weibo.com/wb" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!-- wap uaredirect -->
        <script src="http://img.wyzxwk.com/skin/wywk/js/uaredirect.js" type="text/javascript"></script>
        <script type="text/javascript">
            $(document).ready(function($){
                ...
                $app2pc = $.cookie('RSapp2pc');
                if($opencookie){
                    if($app2pc!=1){
                        uaredirect("<?=$public_r[newsurl]?>m/show.php?classid=<?=$ecms_gr[classid]?>&id=<?=$ecms_gr[id]?>");
                    }
                }
            });
        </script>
