...
<html xmlns:wb="http://open.weibo.com/wb" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="[!--news.url--]skin/default/css/base_1.css" rel="stylesheet" type="text/css" />
        ...
        <div class="logo">
            ...
            <div class="wrap">
                <div class="channelnav clearfix">
                    <div id="ztlogo" class="left"><a href="[!--news.url--]/html/rank.php" target="_self"><img src="[!--news.url--]skin/default/images/bg_channelranking.png" /></a></div>
                    <div class="right">
                    ...
                    <div class="section left">
                        ...
                        <div class="section_content">
                            <ul class="clearfix">
                                ...
                                <!-- 最精彩 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood1 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood1 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最感动 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood2 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood2 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最搞笑 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood3 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood3 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最开心 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood4 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood4 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最愤怒 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood5 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood5 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最无聊 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood6 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood6 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最难过 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood7 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood7 desc limit 1");
                                ?>                        
                                <li>
                                ...
                                <!-- 最同情 -->
                                <?php 
                                    $r=$empire->fetch1("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood8 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 and ispic=1 order by b.mood8 desc limit 1");
                                ?>                        
                                <li>
                        ...
                        <div id="js_ranktab" class="section_content">
                            ...
                            <div class="js_con numlist">
                                <ul>
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood1 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood1 desc limit 10",10,24,0);
if($ecms_bq_sql){
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood2 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood2 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood3 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood3 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood4 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood4 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood5 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood5 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood6 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood6 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood7 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood7 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                                ...
                                <ul style="display: none;">
                                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select a.title,a.titleurl,a.titlepic,a.smalltext,b.mood8 from {$dbtbpre}ecms_article a inner join {$dbtbpre}ecmsextend_mood b on a.id=b.id and a.classid=b.classid  where truetime>UNIX_TIMESTAMP()-86400*7 order by b.mood8 desc limit 10",10,24,0);
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
                ...
                <div class="hotsrank clearfix">
                    <div id="js_clicktab1" class="section listbox left">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400*7','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400*30','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                    ...
                    <div id="js_pltab1" class="section listbox right">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400*7','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('article',10,18,0,'truetime>UNIX_TIMESTAMP()-86400*30','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
                ...
                <div class="hotsrank clearfix">
                    <div id="js_clicktab2" class="section listbox left">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,1,0,'truetime>UNIX_TIMESTAMP()-86400','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,1,0,'truetime>UNIX_TIMESTAMP()-86400*7','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,1,0,'truetime>UNIX_TIMESTAMP()-86400*30','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                    ...
                    <div id="js_pltab2" class="section listbox right">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,9,0,'truetime>UNIX_TIMESTAMP()-86400','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,9,0,'truetime>UNIX_TIMESTAMP()-86400*7','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(36,10,9,0,'truetime>UNIX_TIMESTAMP()-86400*30','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
                ...
                <div class="hotsrank clearfix">
                    <div id="js_clicktab3" class="section listbox left">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,1,0,'truetime>UNIX_TIMESTAMP()-86400','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,1,0,'truetime>UNIX_TIMESTAMP()-86400*7','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,1,0,'truetime>UNIX_TIMESTAMP()-86400*30','onclick desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                    ...
                    <div id="js_pltab3" class="section listbox right">
                        ...
                        <div class="section_content">
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,9,0,'truetime>UNIX_TIMESTAMP()-86400','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,9,0,'truetime>UNIX_TIMESTAMP()-86400*7','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
...
?>
                            ...
                            <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq(47,10,9,0,'truetime>UNIX_TIMESTAMP()-86400*30','plnum desc');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
