...
<head>
    ...
    <title>《红歌会周刊》2017年3月第2期 - <?=$public_r['sitename']?></title>
...
<?
        $ztid=159;  //取得当前专题id并赋给变量$ztid，以供SQL查询使用；
...
?>
    ...
    <div class="cont_pl">
        <div id="plpost" class="pl_list">
            <!-- 评论 -->
           <!--PC版-->
<div id="SOHUCS" sid="《红歌会周刊》2017年3月第2期" ></div>
...
conf: 'prod_eb841ff6ba533cd3f322c05e9252c602'
    ...
    <!--底部结束-->
    <script src=http://www.szhgh.com/e/public/onclick/?enews=dozt&ztid=159></script>
</body>
</html>