...
<head>
    ...
    <title>山东教授邓相超辱毛事件 - <?=$public_r['sitename']?></title>
    <meta name="keywords" content="" />
    <meta name="description" content="2016年12月26日毛主席诞辰纪念日，山东省政府参事、山东省政协常委、山东建筑大学教授邓相超在其微博上发言辱骂毛主席，激起广大党员和人民群众的义愤。后来发现，他绝非是“初犯”。" />
...
<?
        $ztid=148;  //取得当前专题id并赋给变量$ztid，以供SQL查询使用；
    ...
    <div class="hea_2" style='background: url("<?=$zt_r[ztbg]?>") no-repeat scroll center center transparent;'>
        <div class="g-wrap f-cb">
            <div class="m-guide f-fl">
                ...
                <div  style="color:<?=$parameter_r[0]?>;" class="u-intro">2016年12月26日毛主席诞辰纪念日，山东省政府参事、山东省政协常委、山东建筑大学教授邓相超在其微博上发言辱骂毛主席，激起广大党员和人民群众的义愤。后来发现，他绝非是“初犯”。</div>
            </div>
...
<!--PC版-->
<div id="SOHUCS" sid="山东教授邓相超辱毛事件" ></div>
...
conf: 'prod_eb841ff6ba533cd3f322c05e9252c602'
    ...
    <!--底部结束-->
    <script src=http://www.szhgh.com/e/public/onclick/?enews=dozt&ztid=148></script>
</body>
</html>