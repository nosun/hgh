...
$qmessage_r=array(
	...
	'AddQinfoSuccess'=>'投稿提交成功！我们将尽快在48小时内通过审核或删除，请自行保留底稿，感谢您的支持！',
	...
	'VoteSuccess'=>'感谢您的投票',
	'EmptyPl'=>'请输入评论内容',
	'EmptyPlMustF'=>'{:I,15:}字段[$FieldName]的值为空，请将必填项填写完整',
	...
	'FaiUserlen'=>'用户名长度有误,约定长度:{$min_userlen}-{$max_userlen}个字符,一个汉字算作两个字符.',
	'FailPasslen'=>'密码位数不够或过长,约定长度:{$min_passlen}-{$max_passlen}个字符',
	...
	'NotCheckedUser'=>'您的帐号还未通过审核或者等待激活.',
	'ExitSuccess'=>'退出系统成功！',
	...
	'HaveNotTags'=>'此TAG不存在',
        ...
        'BindEISuccess'=>'{:S,0:}第三方应用绑定成功!',
        'BindEIFail'=>'{:E,19:}第三方应用绑定失败!',
);
?>