...
function sys_GetClassNewsPic($classid,$line,$num,$width,$height,$showtitle=true,$strlen,$enews=0,$ewhere='',$eorder=''){
    ...
    while($r=$empire->fetch($sql)){
        ...
        $class_text.="<li><a href='".$titleurl."' target=_blank><img src='".sys_ResizeImg($r[titlepic],$width,$height,1,'')."' title='".$oldtitle."' />".$title."</a></li>";
        //分割
...
//调用生成缩图
function sys_ResizeImg($file,$width,$height,$docut=0,$target_filename='',$target_path='d/file/small/'){
	global $public_r,$ecms_config,$efileftp;
