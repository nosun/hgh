...
*/ 
function imageWaterMark($groundImage,$waterPos=0,$waterImage="",$waterText="",$textFont=5,$textColor="#FF0000",$myfontpath='/e/data/mask/cour.ttf',$w_pct,$w_quality){
	global $fun_r;//LGM修改,将$waterImage,$myfontpath路径改为绝对路径[2014年3月12日20:59].
	$waterImage=$waterImage?$waterImage:'';
	$myfontpath=$myfontpath?$myfontpath:'';
    $isWaterImage = FALSE; 
