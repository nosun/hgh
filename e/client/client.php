...
/**
 * 高级修改用户资料,可改用户名(LGM增加[2014年3月19日18:22])
 * @param int $userid
 ...
 * @return int
 */
function uc_user_modify($userid,$username, $oldpw, $newpw, $email, $ignoreoldpw = 0) {
	return call_user_func(UC_API_FUNC, 'user', 'modify', array('userid'=>$userid, 'username'=>$username, 'oldpw'=>$oldpw, 'newpw'=>$newpw, 'email'=>$email, 'ignoreoldpw'=>$ignoreoldpw));
}
