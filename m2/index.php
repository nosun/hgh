...
$query1=$select." isgood>=1 order by newstime desc limit 10";
...
<section class="li{$vi1}">
<div class="img-text">
                        <a href="$titleurl"> <img style="float:right;height:70px;overflow:hidden" src='{$r[titlepic]}' /></a>
                    <a style="font-size: 14px" href="{$titleurl}"><b>{$r[title]}<br></b></a>
                    <p style="font-size:13px;">{$passedtimestr}  &nbsp; &nbsp;&nbsp; {$class_r[$r['classid']]['classname']}  &nbsp; &nbsp; {$r['author']}</p>
                    </div>
</section>
VX_DEND;
