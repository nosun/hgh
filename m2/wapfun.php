...
<tr>
    ...
    <nav class="top_nav" id="lanmu" hidden style="position:absolute;z-index:1;font-size: 15px">
        <table style="height:110px;width: 100%;background-color:rgb(243,243,243);font-family: 黑体"><tr><td>
            <a href="index.php" style="font-size: 16px">推荐</a></td>
                    <td><a href="list.php?classid=36" class="navlist" style="font-size: 16px">资讯中心</a></td>
                    <td><a href="list.php?classid=52" class="navlist" style="font-size: 16px">红色中国</a></td>
                    <td><a href="list.php?classid=47" class="navlist" style="font-size: 16px">纵论天下</a></td>
                    <td><a href="list.php?classid=53" class="navlist" style="font-size: 16px">唱读讲传</a></td></tr><tr>
                    <td></td><td><a href="list.php?classid=54" class="navlist" style="font-size: 16px">人民健康</a></td>
                    <td><a href="list.php?classid=55" class="navlist" style="font-size: 16px">工农家园</a></td>
                    <td><a href="list.php?classid=56" class="navlist" style="font-size: 16px">文史·读书</a></td>
                    <td><a href="list.php?classid=57" class="navlist" style="font-size: 16px">第三世界</a></td></tr><tr>
    ...
    <?php    if($title == '首页') { ?>
        ...
        <table style="width: 100%;background-color:rgb(243,243,243);font-size: 15px;font-family: 黑体"><tr><td>
                    <a href="index.php" style="" style="font-size: 16px">推荐</a></td>
                <td><a href="list.php?classid=36" style="font-size: 16px">资讯中心</a></td>
                <td><a href="list.php?classid=52" style="font-size: 16px">红色中国</a></td>
                <td><a href="list.php?classid=47" style="font-size: 16px">纵论天下</a></td>
                <td><a href="list.php?classid=53" style="font-size: 16px">唱读讲传</a></td></tr><tr>
                <td></td><td><a href="list.php?classid=54" style="font-size: 16px">人民健康</a></td>
                <td><a href="list.php?classid=55" style="font-size: 16px">工农家园</a></td>
                <td><a href="list.php?classid=56" style="font-size: 16px">文史·读书</a></td>
                <td><a href="list.php?classid=57" style="font-size: 16px">第三世界</a></td></tr><tr>
                <td></td><td></td><td></td><td></td>
                <td align="center">
                    <img id="arrow-up" onclick="lamuaddhidden()" style="height: 10px" src="hgh/images/arrow-up_03.png">
                </td></tr>
    ...
    <nav class="top_nav" id="shouye">
        <table style="width: 100%;background-color:rgb(243,243,243);font-family: 黑体;font-size: 15px"><tr><td>
                    <a href="index.php" style="font-size: 16px">推荐</a></td>
                <td><a href="list.php?classid=36" style="font-size: 16px">资讯中心</a></td>
                <td><a href="list.php?classid=52" style="font-size: 16px">红色中国</a></td>
                <td><a href="list.php?classid=47" style="font-size: 16px">纵论天下</a></td>
    ...
    function DoNews($data,$type){
        ...
        if($type == 1){		//相关文章
            ...
            while ($r = $empire->fetch($sql)) {
                $titleurl = 'show.php?classid='.$r['classid'].'&id='.$r['id'];
                $r['title'] = DoWapClearHtml($r['title']);
                $temp .= '<span style="width: 45%;display:inline-table; white-space:pre-wrap;margin-right: 5%;style="background-color: white""><img style="width: 100%;height:100px;overflow:hidden" src="'.$r['titlepic'].'"><a style="font-size: 15px;" href="' . $titleurl . '" title="' . $r['title'] . '">' . $r['title'] . '</a></span>';
            }
        } elseif($type == 3){		//两日热点
