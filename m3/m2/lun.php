...
$line=30;//每页显示记录数
$offset=$page*$line;
$query="select id,classid,title,titlepic,ftitle,newstime,author from {$dbtbpre}ecms_article where classid in(48,49,50,51) ";
$totalnum=intval($_GET['totalnum']);
if($totalnum<1)
{
	$totalquery="select count(*) as total from {$dbtbpre}ecms_article where classid in(48,49,50,51) and isgood=1 ";
...
$pcdirurl = 'http://www.szhgh.com/Article/opinion/';
DoWapHeader($pagetitle);
?>
<article id='Wapper'>
	<section class='column'>
		<h2><a>纵论天下</a> <div class='jian'></div></h2>
		<div id="content">
